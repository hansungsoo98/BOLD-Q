...
class QuantFalconDecoderLayer(nn.Module):
    def __init__(self, config: FalconConfig,
        ...
        if config.new_decoder_architecture:
            ...
            self.ln_attn = copy.deepcopy(ori_layer.ln_attn)
            # The layer norm before the MLP
            self.ln_mlp = copy.deepcopy(ori_layer.ln_mlp)
        else:
            self.input_layernorm = copy.deepcopy(ori_layer.input_layernorm)
            if not config.parallel_attn:
                self.post_attention_layernorm = copy.deepcopy(ori_layer.post_attention_layernorm)
